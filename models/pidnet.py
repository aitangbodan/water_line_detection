...
import time
from .model_utils import BasicBlock, Bottleneck, segmenthead, PagFM, Bag, Light_Bag
from .LCPPM_test import *
from .LPEM_test import *
import logging
...
class PIDNet(nn.Module):
    ...
    def __init__(self, m=2, n=3, num_classes=19, planes=64, ppm_planes=96, head_planes=128, augment=True):
        ...
        self.LPEM1 = LPEM(planes * 4)
        self.layer4 = self._make_layer(BasicBlock, planes * 4, planes * 8, n, stride=2)
        self.LPEM2 = LPEM(planes * 8)
        ...
        if m == 2:
            ...
            self.spp = LCPPM(planes * 16, ppm_planes, planes * 4)
    ...
    def forward(self, x):
        ...
        x = self.LPEM1(self.relu(self.layer3(x)))
        ...
        x = self.LPEM1(self.relu(self.layer4(x)))
