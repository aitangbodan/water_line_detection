...
def parse_args():
    ...
    parser.add_argument('--a', help='pidnet-s, pidnet-m or pidnet-l', default='pidnet-m', type=str)
    parser.add_argument('--c', help='number of classes', type=int, default=2)
    parser.add_argument('--r', help='input resolution', type=int, nargs='+', default=(960,720))     
